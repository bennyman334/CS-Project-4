...
int main(int argc, char* argv[]) {
    ...
    std::ifstream infile("/Users/benjaminli/Library/Developer/Xcode/DerivedData/CS32_Project4-exryrwgepsmwfkfllkjpdllaednd/Build/" + param_filename);
    if (!infile)
    {
    ...
    if (!airport_db.load_airport_data("/Users/benjaminli/Library/Developer/Xcode/DerivedData/CS32_Project4-exryrwgepsmwfkfllkjpdllaednd/Build/airports.txt")) {
        std::cerr << "Failed to load airport data.\n";
        return 1;
    }

      // Attempt to load the flights data
    if (!flight_manager.load_flight_data("/Users/benjaminli/Library/Developer/Xcode/DerivedData/CS32_Project4-exryrwgepsmwfkfllkjpdllaednd/Build/all_flights.txt")) {
